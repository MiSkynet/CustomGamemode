...
public class IndexMenuItem {
    ...
    public static ItemStack buildRewardItemStack(IndexLevel level, Player player) {
        ...
        Integer currentConfigPlayerLevel = new LevelingSystem().getPlayerLevel(player);
        ...
        if (unlockedLevels != null && !(unlockedLevels.contains(level.getLevel()))) {
            ...
            lore.add(ComponentUtils.component(false, "&8Current Progress: " + new LevelingSystem().getPlayerLevel(player) + "/" + level.getRequiredLevel()));
        }
