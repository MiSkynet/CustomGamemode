...
public class ItemPreviewItem {
    ...
    public ItemStack toItemStack() {
        ...
        PlayerHead item = new PlayerHead(Utils.component(false, "&cError while creating item!"), "5c8817ee8e9c2c2bf767487737e0a60a5e09b725138e14daa57480a03f1766d8");
        ArrayList<Component> lore = new ArrayList<>();
        if (itemType.toString().toLowerCase().equals("buy")) {
            item = new PlayerHead(Utils.component(false, "&aBuy " + amount),"23a45195193b5d6de5c522171d6a75abdaa78aacd901556dd0d8817c0ed810f3");
            lore.add(Utils.component(false, "&7Buy " + amount + " for " + Main.economyManager.getDisplayFormat(amount * price) + Main.economyManager.getEcoSymbol()));
        }else if (itemType.toString().toLowerCase().equals("sell")) {
            item = new PlayerHead(Utils.component(false, "&aSell " + amount),"4bf360ee0b5578f10189900a21d631e6a88c296cfa3a00f1e2c2dc73588a3a8d");
            lore.add(Utils.component(false, "&7Sell " + amount + " for " + Main.economyManager.getDisplayFormat(amount * price) + Main.economyManager.getEcoSymbol()));
        }
    ...
    public static ItemStack getUnavailableItem() {
        return new Item(Material.BARRIER, Utils.component(false, "&cNot available")).toItemStack();
    }
}
