...
public class EcoCommand implements BasicCommand {
    ...
    public void execute(CommandSourceStack commandSourceStack, String[] args) {
        ...
        if (firstArg.equals("set") || firstArg.equals("add")) {
            ...
            if (target == null) {
                sender.sendMessage(Utils.component("&cPlayer " + args[1] + " is not a valid player"));
                return;
            }
            ...
            switch (args[0].toLowerCase()) {
                ...
                case "add" -> {
                    ...
                    sender.sendMessage(Utils.component("&aAdded " + amount + Main.economyManager.getEcoSymbol() + " to the balance of " + target.getName()));
                }
            }
            return;
        }
        ...
        if (firstArg.equals("get")) {
            ...
            sender.sendMessage(Utils.component("&a" + target.getName() + "'s balance is: " + Main.economyManager.getBalance(target) + Main.economyManager.getEcoSymbol()));
        }
    }
}
